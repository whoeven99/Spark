      ...
      tools: [
        {
          ...
          params: [
            ...
            { name: "limitPerType", type: "number", desc: "每类资源最多翻译数量，1-200，默认 20" },
            {
              name: "resourceTypes",
              type: "string[]",
              desc: "翻译模块：PRODUCT、PRODUCT_OPTION、PRODUCT_OPTION_VALUE、COLLECTION、ONLINE_STORE_THEME_APP_EMBED、ONLINE_STORE_THEME_JSON_TEMPLATE、ONLINE_STORE_THEME_SECTION_GROUP、ONLINE_STORE_THEME_SETTINGS_DATA_SECTIONS、MENU、LINK、DELIVERY_METHOD_DEFINITION、FILTER、METAFIELD、METAOBJECT、PAYMENT_GATEWAY、SELLING_PLAN、SELLING_PLAN_GROUP、SHOP、ARTICLE、BLOG、PAGE",
            },
          ],
        },
      ],
