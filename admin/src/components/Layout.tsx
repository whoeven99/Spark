...
export default function Layout() {
  ...
  const allMenuItems = [
    ...
    { key: "/pricing-studio", icon: <CalculatorOutlined />, label: <Link to="/pricing-studio">定价工作台</Link>, ownerOnly: true },
    { key: "/pricing-workbench", icon: <CalculatorOutlined />, label: <Link to="/pricing-workbench">定价工作台 v2</Link>, ownerOnly: true },
