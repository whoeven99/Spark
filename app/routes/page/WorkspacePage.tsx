...
const pillStyle: CSSProperties = { padding: "0.35rem 0.65rem", borderRadius: "999px", background: "#f3f4f6", border: `1px solid ${pageColorTokens.borderSubtle}`, color: pageColorTokens.textBody, fontSize: "0.76rem", fontWeight: 600 };
