...
import { ProductImportIssueFixList } from "./ProductImportIssueFixList";
...
export type ProductImportSheetPreviewDensity = "compact" | "dialog";
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
      ...
      <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
        ...
        {preview.selectedOperations.length > 0 && preview.matchedOperations.length > 0 ? (
          <span style={chipStyle}>
      ...
      <ProductImportIssueFixList
        issues={preview.issues}
        issueCount={preview.issueCount}
        limit={compact ? undefined : preview.issues.length}
      />
      {!compact && preview.columns.length > 0 && preview.sampleRows.length > 0 ? (
        <div
          style={{
            maxHeight: 220,
            overflow: "auto",
      ...
      {!compact && preview.rowCount > preview.sampleRows.length ? (
