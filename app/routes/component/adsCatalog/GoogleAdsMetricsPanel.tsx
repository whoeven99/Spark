...
export interface GoogleAdsMetricsPanelProps {
  ...
  customerId: string;
  /** i18n key for panel title; defaults to Google Ads title */
  titleKey?: string;
  /** i18n key for subtitle; receives {{customerId}} */
  subtitleKey?: string;
}
...
export function GoogleAdsMetricsPanel({
  campaigns,
  currencyCode,
  customerId,
  titleKey = "adsCatalog.metricsTitle",
  subtitleKey = "adsCatalog.metricsSubtitle",
}: GoogleAdsMetricsPanelProps) {
