...
export default function TodayProductAnalysisPage() {
  ...
  return (
    <TodayAnalysisPage
      title={localizedPage?.title ?? t("today.topics.productTitle")}
      subtitle={localizedPage?.subtitle ?? t("today.topics.productSubtitle")}
      returnTo={returnTo}
      ...
      lead={{
        ...
        summary: localizedPage?.summary ?? t("today.topics.productSummary"),
