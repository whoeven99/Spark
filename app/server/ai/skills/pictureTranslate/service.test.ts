...
import { ERROR_MESSAGES, MAX_IMAGE_BYTES } from "./constants";
...
vi.mock("../../../pictureTranslate/pictureTranslateExecutor.server", () => ({
  executePictureTranslatePipeline: mocks.executePictureTranslatePipeline,
}));

vi.mock("../../../pictureTranslate/volcenginePictureTranslate.server", () => ({
  fetchSourceImageBytes: mocks.fetchSourceImageBytes,
}));

vi.mock("../../../generateDescription/generateDescriptionLog.server", () => ({
