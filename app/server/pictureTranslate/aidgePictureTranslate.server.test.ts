...
vi.mock("./aidgeIopRequest.server", async (importOriginal) => {
  const actual = await importOriginal<typeof import("./aidgeIopRequest.server")>();
  return {
    ...actual,
...
} from "./aidgePictureTranslate.server";
